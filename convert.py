...
# Example usage
convert_mp4_to_gif("sa4d/static/videos/teaser-video.mp4", "teaser.gif", start_time=0, end_time=None, resize=500)
# convert_mp4_to_gif("sa4d/static/videos/teaser.mp4", "teaser-paper.gif", start_time=0, end_time=None, resize=500)
